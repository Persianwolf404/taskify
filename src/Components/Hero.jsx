  ...
  return (
    <>
      <section className=' Hero w-full h-[100vh] flex justify-center items-center '>
        <div className='flex flex-col '>
          ...
          <div className='flex justify-center items-center '>
            <span className='text-[#c1c9d3] text-[5.5em] leading-[1.1] font-medium'>Inspiring Change</span>
            <span
              className='
                flex  
                items-center
                ...
                mr-[0.2em]'
            >
              <i ref={iconRef} className="text-[#08B9B5] text-[25px] fas fa-asterisk"></i>
            </span>
          ...
          <div className='m-0 mt-4 flex justify-center items-center'>
            ...
            <span ref={taskify} className=' m-0 mr-3 text-[5.5em] leading-[1.1] text-[#AAB2BB] font-medium'>
              Taskify
            </span>
            <div ref={Fostersmainparent} className='m-0'>
              <h1 ref={Fosters} className='mr-6 mb-2 text-[#08B9B5] text-[5em] leading-[1.1] font-medium'>
                Fosters
              </h1>
            </div>
          ...
          <div className='m-0 flex justify-start  '>
            ...
            <div ref={Progressmainparent} className='m-0'>
              <h1 ref={Progress} className='mb-[10px] text-[#08B9B5] m-0 inline-block text-[5em] leading-[1.1] font-medium'>
                Progress
              </h1>
      ...
      <div className={`flex m-0 mt-[150px] relative  w-full`}>
        <div ref={parent} className='w-0 flex h-full border-b-2 border-[#5d6067] absolute '>
        </div>
