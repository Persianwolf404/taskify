...
const GraphicDesign = () => {
  ...
  return (
    <>
      <span ref={title}></span>
      <div
        className={`$1{raleway.className} mb-20  text-5xl bg-red-200 text-[#c1c9d3]`}
      >
        <div className="flex w-full   ">
          <div className="flex flex-col items-center">
            <h2 className=" leading-[60px] mb-10 text-center top-[20%] left-[5%] ">
        ...
        <div className="flex mt-20 ">
          <div>
            ...
            <div className="flex flex-col border-b-2 pb-5 border-gray-500 w-full">
              ...
              <div className="m-0 w-full flex MdOutlineArrowForward ">
                <h2 className=" mt-7 text-white text-4xl ml-1 m-0">
                  Through The Wood
                </h2>
                <MdOutlineArrowForward className="mr-1 mt-auto text-3xl rotate-[5]" />
              </div>
